namespace ManSys
{
	partial class Generar_JornadaLaboral
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.ListadoDeEntradsSalidas = new System.Windows.Forms.DataGridView();
			this.HoraActualTimer = new System.Windows.Forms.Timer(this.components);
			this.ListadoDeEntradasYSalidasTimer = new System.Windows.Forms.Timer(this.components);
			...
			((System.ComponentModel.ISupportInitialize)(this.ListadoDeEntradsSalidas)).BeginInit();
			this.SuspendLayout();
			// 
			...
			// TopToolStripPanel
			// 
			this.TopToolStripPanel.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch;
			...
			this.ContentPanel.Size = new System.Drawing.Size(222, 362);
			// 
			// toolStripContainer1
			// 
			...
			// 
			this.toolStripContainer1.ContentPanel.Controls.Add(this.HoraActual);
			this.toolStripContainer1.ContentPanel.Controls.Add(this.btnCerrar);
			this.toolStripContainer1.ContentPanel.Controls.Add(this.btnSalida);
			this.toolStripContainer1.ContentPanel.Controls.Add(this.btnEntrada);
			this.toolStripContainer1.ContentPanel.Controls.Add(this.Contra);
			...
			this.toolStripContainer1.ContentPanel.Size = new System.Drawing.Size(1178, 643);
			this.toolStripContainer1.LeftToolStripPanelVisible = false;
			this.toolStripContainer1.Location = new System.Drawing.Point(648, 227);
			this.toolStripContainer1.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.toolStripContainer1.Name = "toolStripContainer1";
			this.toolStripContainer1.RightToolStripPanelVisible = false;
			this.toolStripContainer1.Size = new System.Drawing.Size(1178, 643);
			this.toolStripContainer1.TabIndex = 140;
			...
			this.btnCerrar.Location = new System.Drawing.Point(937, 371);
			...
			this.btnSalida.Location = new System.Drawing.Point(675, 371);
			this.btnSalida.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btnSalida.Name = "btnSalida";
			this.btnSalida.Size = new System.Drawing.Size(202, 43);
			this.btnSalida.TabIndex = 155;
			...
			this.btnEntrada.Location = new System.Drawing.Point(413, 371);
			this.btnEntrada.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.btnEntrada.Name = "btnEntrada";
			this.btnEntrada.Size = new System.Drawing.Size(202, 49);
			this.btnEntrada.TabIndex = 154;
			...
			this.label14.Text = "GENERAR ENTRADA O SALIDA";
			// 
			...
			// HoraActualTimer
			// 
			this.HoraActualTimer.Tick += new System.EventHandler(this.HoraActualTimer_Tick);
			// 
			// ListadoDeEntradasYSalidasTimer
			// 
			this.ListadoDeEntradasYSalidasTimer.Interval = 2000;
			this.ListadoDeEntradasYSalidasTimer.Tick += new System.EventHandler(this.ListadoDeEntradasYSalidasTimer_Tick);
			// 
			// EmpleadoId
			// 
			...
			this.Controls.Add(this.ListadoDeEntradsSalidas);
			this.Controls.Add(this.toolStripContainer1);
			this.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None;
			this.Name = "Generar_JornadaLaboral";
			this.Text = "Generar Entrada o Salida";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.Generar_JornadaLaboral_Load);
			this.toolStripContainer1.ContentPanel.ResumeLayout(false);
			this.toolStripContainer1.ContentPanel.PerformLayout();
			this.toolStripContainer1.ResumeLayout(false);
			this.toolStripContainer1.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.ListadoDeEntradsSalidas)).EndInit();
		...
		private System.Windows.Forms.DataGridView ListadoDeEntradsSalidas;
		private System.Windows.Forms.Label HoraActual;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.Timer HoraActualTimer;
		private System.Windows.Forms.Timer ListadoDeEntradasYSalidasTimer;
