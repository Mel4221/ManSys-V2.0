namespace ManSys
{
    partial class mantenimientoPosc
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(mantenimientoPosc));
			...
			this.label14.Size = new System.Drawing.Size(636, 40);
			this.label14.TabIndex = 166;
			this.label14.Text = "MANTENIMIENTO DE POSICIONES";
			// 
			// toolStripContainer1
			// 
			...
			this.label13.Location = new System.Drawing.Point(54, 296);
			...
			this.label4.Text = "Nombre de Posición";
			// 
			// label1
			// 
			...
			this.Name = "mantenimientoPosc";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "mantenimientoPosc";
			this.Load += new System.EventHandler(this.mantenimientoPosc_Load);
			this.MouseDown += new System.Windows.Forms.MouseEventHandler(this.mantenimientoPosc_MouseDown);
