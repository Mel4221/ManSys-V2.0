...
namespace ManSys
{
    partial class Consulta_de_Deducciones
    {
        ...
        private void InitializeComponent()
        {
			...
			this.ListadoDeDeducciones = new System.Windows.Forms.DataGridView();
			...
			((System.ComponentModel.ISupportInitialize)(this.ListadoDeDeducciones)).BeginInit();
			this.SuspendLayout();
			// 
			// toolStripContainer1
			// 
			...
			// Tipo
			// 
			this.Tipo.FlatStyle = System.Windows.Forms.FlatStyle.System;
			this.Tipo.FormattingEnabled = true;
			this.Tipo.Items.AddRange(new object[] {
            "Applicacion Personal",
            "Applicacion A Todos",
            "Nombre",
            "Valor"});
			...
			this.Tipo.TabIndex = 274;
			this.Tipo.Text = "Applicacion Personal";
			// 
			// gblistadovisitas
			// 
			this.gblistadovisitas.Controls.Add(this.btnRefrescar);
			this.gblistadovisitas.Controls.Add(this.ListadoDeDeducciones);
			...
			this.gblistadovisitas.Text = "Deducciones Registradas";
			// 
			// btnRefrescar
			// 
			...
			// 
			this.ListadoDeDeducciones.BackgroundColor = System.Drawing.SystemColors.ButtonFace;
			this.ListadoDeDeducciones.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.ListadoDeDeducciones.Location = new System.Drawing.Point(9, 74);
			this.ListadoDeDeducciones.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
			this.ListadoDeDeducciones.Name = "ListadoDeDeducciones";
			this.ListadoDeDeducciones.ReadOnly = true;
			this.ListadoDeDeducciones.RowHeadersWidth = 62;
			this.ListadoDeDeducciones.Size = new System.Drawing.Size(1158, 235);
			this.ListadoDeDeducciones.TabIndex = 8;
			// 
			// txtnombre
			// 
			...
			this.label22.Size = new System.Drawing.Size(492, 35);
			this.label22.TabIndex = 270;
			this.label22.Text = "CONSULTA DE DEDUCCIONES";
			// 
			// label1
			// 
			...
			this.Name = "Consulta_de_Deducciones";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Consulta_de_Deducciones";
			this.Load += new System.EventHandler(this.Consulta_de_Deducciones_Load);
			this.MouseDown += new System.Windows.Forms.MouseEventHandler(this.Consulta_de_Deducciones_MouseDown);
			this.toolStripContainer1.ContentPanel.ResumeLayout(false);
			this.toolStripContainer1.ContentPanel.PerformLayout();
			this.toolStripContainer1.ResumeLayout(false);
			this.toolStripContainer1.PerformLayout();
			this.gblistadovisitas.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.ListadoDeDeducciones)).EndInit();
        ...
        private System.Windows.Forms.DataGridView ListadoDeDeducciones;
